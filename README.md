...
In this tool, I strive to combine the power of SSR, SPA, and component-based
...
1. Any component can implement its own independent set of API handlers that
   return hypertext (other components).
2. Any component is rendered on the server and has access to the server
   environment.
3. Any component can be called and re-rendered independently.
4. Components form a hierarchy, can be nested within each other, and can return
...
8. The library that renders components and implements the API can be integrated
